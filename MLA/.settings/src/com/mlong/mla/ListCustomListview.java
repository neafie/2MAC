...
public class ListCustomListview extends ArrayAdapter<ListItem> {
	...
	*/
	public ListCustomListview(Context context, int textViewResourceId, ArrayList<ListItem> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent){
		...
		if (v == null) {
			...
			v = inflater.inflate(R.layout.activity_list_custom_listview, null);
		}
